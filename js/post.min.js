function e(a){this.wiki=function(){this.encloseSelection("","",function(b){return f(a,b,!0)})};this.xhtml=function(){this.encloseSelection("","",function(b){return f(a,b,!1)})}}var g=/^\s*\(\(([^()|]+)(\|[^()]*)\)\)\s*$/,h=/^\s*<img (?:[^>]* )?src=["']([^"'>]+)["'](?: [^>]*)?>\s*$/;function k(a,b,c){b=b.match(c);return b?b[1]:(alert(a.selectImageError),null)}
